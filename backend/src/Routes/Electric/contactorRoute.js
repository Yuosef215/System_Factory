...
router.get("/", protect, allowedTo("warehouse_worker","developer","warehouse_manager","electricity_manager","ceo"), getAllContactors);
router.get("/allMovements", protect, allowedTo("warehouse_worker","developer","warehouse_manager","ceo"), getAllContactorMovements);
...
router.get("/movements/:id", protect, allowedTo("warehouse_worker","developer","warehouse_manager","ceo"), getContactorMovements);
